<div class="row rounded border border-secondary bg-light p-2 mb-3">
	<div class="col-10">
		<div class="row">
			<div class="col-3 loc">
...
while ($r = pg_fetch_row($result2)) {
    include "liste_annonce_objet_attribut.php";
}
?>
	...
	<div class="col-2 loc">
		<button class="btn btn-primary mx-auto loc-item" onclick="window.location = './annonce.php?object_id=<?php echo $row[0]; ?>';">Modifier</button>
	</div>
</div>
